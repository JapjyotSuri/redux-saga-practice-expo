...
import { updateNameFailure, updateNameSuccess, userReducer } from '../features/updateNameSlice';
...
function* userSaga() {//this is a watcher
  yield takeEvery(userReducer.type, fetchUser)//till the time this line is not executed yield pauses the execution of this function
